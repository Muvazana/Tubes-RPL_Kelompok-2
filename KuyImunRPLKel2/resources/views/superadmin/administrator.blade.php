                                        ...
                                        <tr class="bg-white border-collapse">
                                            ...
                                            @if($user->role == "admin")
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3 w-10">
                                                    <a href="{{ url('/superadmin/administrator/edit/'.$user->id) }}" class="px-5 py-2 bg-blue-500 rounded-md text-white">Edit</a>
                                                    <a href="{{ url('/superadmin/administrator/delete/'.$user->id) }}" class="px-5 py-2 bg-red-500 rounded-md text-white">Delete</a>
                                                </td>
                                            @else
